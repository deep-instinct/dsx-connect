...
from dsx_connect_v2.control_plane.bootstrap import ControlPlaneBootstrapResult
...
from dsx_connect_v2.jobs.repository import InMemoryJobRepository, JobRepository
from dsx_connect_v2.jobs.rabbitmq_bus import RabbitMQJobBus
...
def _build_job_repo(control_plane_bootstrap: ControlPlaneBootstrapResult) -> JobRepository:
    if control_plane_bootstrap.backend == "postgres":
        from dsx_connect_v2.jobs.postgres_repo import PostgresJobRepository
