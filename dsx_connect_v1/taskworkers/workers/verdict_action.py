# dsx_connect_v1/taskworkers/workers/verdict_action.py
...
from dsx_connect_v1.taskworkers.dlq_store import enqueue_verdict_action_dlq_sync, make_verdict_action_dlq_item
