...
The reusable implementation now lives in `dsx_connect_v1/sdk/`.

## Requirements

- Python 3
- `requests` and `typer` (see `dsx_connect_v1/requirements.txt`)
...
```bash
python3 dsx_connect_v1/prototypes/dianna-client/test_dianna_api_client_cli.py \
