# dsx_connect_v1/taskworkers/workers/scan_result.py
...
from dsx_connect_v1.taskworkers.names import Tasks, Queues
from dsx_connect_v1.taskworkers.workers.base_worker import BaseWorker, RetryGroup, RetryGroups
from dsx_connect_v1.taskworkers.dlq_store import enqueue_scan_result_dlq_sync, \
    make_scan_result_dlq_item
from dsx_connect_v1.taskworkers.errors import TaskError, MalformedScanRequest, MalformedResponse

from dsxa_sdk_py.models import ScanResponse
from shared.models.connector_models import ScanRequestModel, ItemActionModel
from dsx_connect_v1.models.scan_result import ScanResultModel, ScanResultStatusEnum
from shared.dsx_logging import dsx_logging
from shared.models.status_responses import ItemActionStatusResponse
from dsx_connect_v1.messaging.state_keys import job_key
...
class ScanResultWorker(BaseWorker):
    ...
    def __init__(self):
        ...
        if self.__class__._scan_results_db is None:
            ...
            from dsx_connect_v1.database.database_factory import (
    ...
    def _best_effort_extras(self, scan_result: ScanResultModel) -> None:
        ...
        try:
            ...
            if getattr(cfg.workers, "enable_scan_stats", True):
                try:
                    from dsx_connect_v1.database.scan_stats_worker import ScanStatsWorker
            ...
            try:
                ...
                if (
                    ...
                    try:
                        from dsx_connect_v1.database.dianna_siem_index_redis import DiannaSiemIndexRedis
