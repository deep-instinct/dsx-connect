...
- `DSX_CONNECT_V2__CONNECTOR_REGISTRATION_AUTH_ENABLED=true`
- `DSX_CONNECT_V2__CONNECTOR_ENROLLMENT_TOKENS=token-a,token-b`
...
- `DSX_CONNECT_V2__CONNECTOR_REGISTRATION_AUTH_ENABLED=true`, or
- `DSX_CONNECT_V2__CONNECTOR_ENROLLMENT_TOKENS` contains at least one token.
