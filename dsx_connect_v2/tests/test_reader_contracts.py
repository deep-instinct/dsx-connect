...
from dsx_connect_v2.config import ReaderSettings
from dsx_connect_v2.jobs.bus import InMemoryJobBus
from dsx_connect_v2.jobs.contracts import ScanItemRequested
from dsx_connect_v2.jobs.models import BatchJobSubmitRequest, ContentSource
from dsx_connect_v2.jobs.repository import InMemoryJobRepository
from dsx_connect_v2.jobs.service import JobService
from dsx_connect_v2.readers.cached import CachedArtifactReader
from dsx_connect_v2.readers.contracts import ArtifactRef, ConnectorProxyReadRequest, ConnectorProxyReadResponse, ReaderErrorPayload
from dsx_connect_v2.readers import gcs_native as gcs_native_module
from dsx_connect_v2.readers.gcs_native import GCSNativeReader, resolve_gcs_object_ref
from dsx_connect_v2.readers import proxy as proxy_module
from dsx_connect_v2.readers.base import TerminalScanError
from dsx_connect_v2.readers.proxy import ConnectorProxyReader, ConnectorProxyRuntimeConfig, build_legacy_connector_read_payload, http_connector_proxy_read
from dsx_connect_v2.readers.resolver import build_scan_reader
from dsx_connect_v2.workers import scan_worker
...
def test_reader_settings_accept_chunk_size_env(monkeypatch) -> None:
    monkeypatch.setenv("DSX_CONNECT_V2_READERS__CHUNK_SIZE_BYTES", "2097152")
...
def test_filesystem_batch_payload_path_flows_to_legacy_connector_location() -> None:
    request = _scan_request_from_submitted_item(
        ...
        payload={
            ...
            "path": "/tmp/dsx-connect-v2/proxy-reader-sample.txt",
        },
    )
    ...
    assert proxy_request.options["path"] == "/tmp/dsx-connect-v2/proxy-reader-sample.txt"
    assert payload["location"] == "/tmp/dsx-connect-v2/proxy-reader-sample.txt"
