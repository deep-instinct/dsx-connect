...
const { DSXAClient } = require("./index.cjs");

async function scanFilePath(client, filePath, opts = {}) {
...
async function scanFolder(client, folder, { concurrency = 4, perFile = {} } = {}) {
  const files = [];
...
module.exports = { DSXAClient, scanFilePath, scanFolder };
