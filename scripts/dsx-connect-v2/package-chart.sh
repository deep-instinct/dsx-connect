...
usage() {
  cat <<'EOF'
Usage: scripts/dsx-connect-v2/package-chart.sh [--version VERSION] [--app-version VERSION] [--destination DIR] [--push OCI_REPO]

Examples:
  scripts/dsx-connect-v2/package-chart.sh
  scripts/dsx-connect-v2/package-chart.sh --push oci://registry-1.docker.io/dsxconnect
EOF
}
