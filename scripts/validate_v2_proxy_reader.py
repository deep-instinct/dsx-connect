...
def _json_request(method: str, url: str, payload: dict) -> tuple[int, dict]:
    ...
    try:
        ...
        raise SystemExit(f"request failed: url={url} error={exc.reason}. Is dsx-connect-v2 running and reachable?") from exc
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare and submit a dsx-connect-v2 proxy-reader validation batch.")
