...
from dsx_connect_v2.app import create_app
from dsx_connect_v2.api.routes.ui import _scan_source_label
...
from dsx_connect_v2.jobs.models import BatchJobSubmitRequest, StageUpdateRequest
...
def test_ui_dsxa_status_reports_unreachable(monkeypatch) -> None:
    ...
    from dsx_connect_v2.api.routes import ui as ui_routes
