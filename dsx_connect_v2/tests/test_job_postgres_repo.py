...
from dsx_connect_v2.jobs.models import JobCreate, JobItemCreate, StageRecord, utcnow
psycopg = pytest.importorskip("psycopg")
from dsx_connect_v2.jobs.postgres_repo import PostgresJobRepository, apply_schema


TEST_POSTGRES_URL = os.environ.get("DSX_CONNECT_V2_TEST_POSTGRES_URL")


pytestmark = pytest.mark.skipif(
    not TEST_POSTGRES_URL,
    reason="set DSX_CONNECT_V2_TEST_POSTGRES_URL to run postgres repository tests",
)
