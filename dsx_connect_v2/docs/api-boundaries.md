...
- Set `DSX_CONNECT_V2__CONNECTOR_REGISTRATION_AUTH_ENABLED=true` to require enrollment tokens.
- Set `DSX_CONNECT_V2__CONNECTOR_ENROLLMENT_TOKENS=token-a,token-b` to configure accepted tokens.
