...
try:
    from validate_v2_proxy_reader import EICAR_SAMPLE, ensure_integration, get_batch_job, _get_json
except ModuleNotFoundError:  # pragma: no cover - exercised when imported as scripts.validate_v2_batch_proxy_reader
    from scripts.validate_v2_proxy_reader import EICAR_SAMPLE, ensure_integration, get_batch_job, _get_json
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Submit a multi-item dsx-connect-v2 proxy-reader batch and validate item expansion.")
