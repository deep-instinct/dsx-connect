from dsx_connect_v2.jobs.contracts import DiannaAnalysisRequested, PolicyEvaluationRequested, RemediationRequested, ResultSinkEmitRequested, ScanItemRequested
