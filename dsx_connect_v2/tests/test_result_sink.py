...
from dsx_connect_v2.result_sink.json_lines import JsonLinesResultSink
from dsx_connect_v2.result_sink.models import ResultSinkEvent
from dsx_connect_v2.result_sink.stdout import StdoutResultSink
from dsx_connect_v2.workers.delivery_worker import build_result_sink_executor
...
def test_build_result_sink_uses_stdout_backend(monkeypatch) -> None:
    from dsx_connect_v2.result_sink import bootstrap
