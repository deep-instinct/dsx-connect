<!-- Developer documentation for the Google Cloud Storage Connector (not included in release bundles) -->
...
The GCS connector supports rsync-like include/exclude patterns to control which objects are scanned. Leave empty ("") to scan all objects under DSXCONNECTOR_ASSET (the bucket).
