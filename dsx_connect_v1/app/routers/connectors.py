...
from dsx_connect_v1.connectors import registration
...
from dsx_connect_v1.app.auth_jwt import (
    auth_enabled,
...
from dsx_connect_v1.app.auth_tokens import issue_access_token_opaque
from dsx_connect_v1.app.hmac_provision import ensure_hmac_for_connector, get_hmac_for_connector
...
async def mint_connector_token(request: Request):
    from dsx_connect_v1.config import get_auth_config
    cfg = get_auth_config()
    if not auth_enabled():
