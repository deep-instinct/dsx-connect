...
export DSX_CONNECT_VERSION=2.0.15
```
...
* a container image, such as `dsxconnect/dsx-connect:2.0.15`
* an OCI Helm chart, such as `dsxconnect/dsx-connect-chart --version 2.0.15`
