...
from dsx_connect_v1.taskworkers.workers.base_worker import BaseWorker, RetryGroups
from dsx_connect_v1.taskworkers.errors import (
...
class DiannaAnalysisWorker(BaseWorker):
    ...
    def execute(self, scan_request_dict: dict, *, archive_password: str | None = None,
        ...
        def _persist_terminal_result(*, status: str, analysis: Dict[str, Any] | None = None,
            ...
            try:
                from dsx_connect_v1.database.dianna_analysis_results_redis import DiannaAnalysisResultsRedis
        ...
        try:
            with httpx.Client(timeout=timeout, verify=(cfg.ca_bundle or cfg.verify_tls)) as client:
                ...
                if upload_status in {"FAILED", "ERROR", "CANCELLED", "UNSUPPORTED_FILE_TYPE"}:
                    ...
                    try:
                        from dsx_connect_v1.messaging.bus import SyncBus
                        from dsx_connect_v1.messaging.notifiers import Notifiers
                        from dsx_connect_v1.config import get_config as _gc
