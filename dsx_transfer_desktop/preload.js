...
contextBridge.exposeInMainWorld("dsxTransferDesktop", {
  ...
  pickFile: (purpose) => ipcRenderer.invoke("dsx-transfer-desktop:pick-file", purpose),
  ...
  checkSink: (settings) => ipcRenderer.invoke("dsx-transfer-desktop:check-sink", settings),
