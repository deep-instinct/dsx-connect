...
try:
    from validate_v2_proxy_reader import EICAR_SAMPLE, _get_json, _json_request
except ModuleNotFoundError:  # pragma: no cover - exercised when imported as scripts.validate_v2_filesystem_remediation_e2e
    from scripts.validate_v2_proxy_reader import EICAR_SAMPLE, _get_json, _json_request
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Validate end-to-end dsx-connect-v2 filesystem remediation with proxy read, policy, and quarantine."
    )
