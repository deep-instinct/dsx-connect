# dsx_connect_v1/taskworkers/celery_app.py
from celery import Celery
from kombu import Exchange, Queue
from dsx_connect_v1.config import get_config
from dsx_connect_v1.taskworkers.names import Queues, Tasks
...
celery_app = Celery(
    ...
    include=[
        "dsx_connect_v1.taskworkers.workers.scan_request",
        "dsx_connect_v1.taskworkers.workers.scan_request_batch",
        "dsx_connect_v1.taskworkers.workers.verdict_action",
        "dsx_connect_v1.taskworkers.workers.scan_result",
        "dsx_connect_v1.taskworkers.workers.scan_result_notify",
        "dsx_connect_v1.taskworkers.workers.dianna_analysis",
    ]
)
...
# try:
#     from dsx_connect_v1.taskworkers import taskworkers
#     dsx_logging.debug(f"Successfully imported taskworkers module")
#     from dsx_connect_v1.taskworkers.workers import scan_result_notify
